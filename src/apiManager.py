...
class ApiManager():
        ...
        try:
            ...
            if plantId:
                ...
                if resp.status_code == 200:
                    ...
                    dataCats = list(filter(lambda cat: len(list(filter(lambda sp: sp['itemCategoryId'] == cat['id'], spiralList))) > 0, dataCats))
    ...
    def getItemGroups(self, itemCategoryId):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                data = list(filter(lambda d: len(list(filter(lambda sp: sp['itemGroupId'] == d['id'] ,spiralList))) > 0 ,data))
                # for d in data:
                #     try:
    ...
    def getItems(self, itemCategoryId, itemGroupId):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                data = list(filter(lambda d: len(list(filter(lambda sp: sp['itemId'] == d['id'],spiralList))) > 0,data))
    ...
    def fetchCredits(self, employeeId):
        try:
            ...
            resp = requests.get(self.apiUri + 'Employee/' + str(employeeId) + '/Credits',
                headers={ "Authorization": "Bearer " + self.token })
